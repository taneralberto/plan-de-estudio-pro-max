# Ejemplo Paso a Paso: Hash Tables (Etapa 1, tema 1.5)

Ejemplo concreto de cómo se ve el paso a paso de un tema siguiendo el ciclo de 4 pasos de METODOLOGIA.md.
...
Podés explicar qué pasa internamente cuando hacés `map.set(key, value)` — colisiones, resizing, hashing function — sin mirar apuntes.

---

## Cómo usar este ejemplo

Cuando empieces un tema nuevo, pedile a la AI: *"Armame el paso a paso para [NOMBRE DEL TEMA] siguiendo el template del plan"* y usá este formato como referencia.
